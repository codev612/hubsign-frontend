...
import { defaultNavElement } from "@/constants/canvas";
...
export const handleCanvasObjectModified = ({
  options,
  // syncShapeInStorage,
}: CanvasTypes.CanvasObjectModified) => {
...
}: CanvasTypes.CanvasSelectionCreated) => {
...
export const handleCanvasObjectScaling = ({
  options,
  setElementAttributes,
}: CanvasTypes.CanvasObjectScaling) => {

...
// import { CursorMode, CursorState, Reaction } from "@/types/canvas";
...
import {
  ...
  ContextMenuItem,
  ContextMenuTrigger,
} from "@/components/canvas/ui/context-menu";
import { shortcuts } from "@/constants/canvas";
...
const Live = ({ canvasRef, 
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger
        className="w-full bg-white flex flex-1 justify-center items-center"
        id="canvas"

...
const DropdownboxList: React.FC<DropdownboxListProps> = ({
  ...
  const [selectRecipient, setSelectRecipient] = useState<string>(
    showDropdownboxListForm.value.recipient,
  );
  const [checkRequired, setCheckRequired] = useState<boolean>(
    showDropdownboxListForm.value.required,
  );
  const [items, setItems] = useState<string[]>(
    showDropdownboxListForm.value.items,
  );
